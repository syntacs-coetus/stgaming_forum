...
$l['newpoints_shop_addedit_item_server'] = 'Server';
$l['newpoints_shop_addedit_item_server_desc'] = 'The server this item will be added to';
$l['newpoints_shop_addedit_item_code'] = 'Item Code';
$l['newpoints_shop_addedit_item_code_desc'] = 'Item Code/ID of the item that the system can read.';

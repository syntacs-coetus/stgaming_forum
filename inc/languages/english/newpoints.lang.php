...
$l['newpoints_home_desc'] = 'Cash Points can be used to buy items from the server.<br />This items can then be converted into items towards their respsective servers.<br /><br /><strong>Below is the only way to earn Cash Points on the server</strong><br /><table align="center"><tr><td align="left"><strong>Source</strong></td><td align="right"><strong>Amount</strong></td></tr>{1}</table><br />';
$l['newpoints_home_credits'] = '<br />Contact your administrator if you have any questions.<br />New Points was written by <a href="http://forums.mybb-plugins.com/user-1.html">Diogo Parrinha</a> for <a href="http://mybb.com">MyBB</a>.<br />This software has been modified to become compatible with stgaming products by Dev AtraXaz.';
